...
namespace tablasvisual
{
    public partial class Form3 : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'inventarioDataSet.inventarios' Puede moverla o quitarla según sea necesario.
            this.inventariosTableAdapter.Fill(this.inventarioDataSet.inventarios);
