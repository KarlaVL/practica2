...
namespace tablasvisual
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'inventarioDataSet.categorias' Puede moverla o quitarla según sea necesario.
            this.categoriasTableAdapter.Fill(this.inventarioDataSet.categorias);
